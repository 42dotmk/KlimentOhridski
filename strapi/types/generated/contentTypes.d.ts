...
export interface ApiContactInformationContactInformation
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    facebookDisplayText: Schema.Attribute.String;
...
export interface ApiImageImage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    page: Schema.Attribute.Enumeration<
      ['pocetna', 'uslugi', 'proekti', 'blog', 'kontakt']
    >;
    parentComponent: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['blog', 'content']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
